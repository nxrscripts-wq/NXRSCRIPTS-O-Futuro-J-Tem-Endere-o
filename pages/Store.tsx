...
import { Laptop, Cpu, Router, ShieldCheck, MonitorPlay, Briefcase, ArrowRight, ShoppingBag, X, Check, Activity, Filter, MousePointer2, HardDrive, Search } from 'lucide-react';
...
const PRODUCTS: Product[] = [
  {
    ...
    description: "Memória RAM DDR5 de alta velocidade otimizada para multitarefa intensiva e processamento de segurança.",
    iconName: 'Cpu',
  ...
  },
  {
    ...
    description: "Kit de memória premium para servidores e estações de trabalho que exigem estabilidade absoluta.",
    iconName: 'Cpu',
    specs: ["2x 16GB DDR4 3600MHz", "Perfil XMP 2.0", "Iluminação RGB Customizável", "Compatível com Intel/AMD"],
    category: "Memória RAM"
  },
  {
    id: 'hd-seagate-4tb',
    title: "Seagate IronWolf 4TB",
    description: "Disco rígido especializado para sistemas NAS e armazenamento de logs de segurança em larga escala.",
    iconName: 'HardDrive',
  ...
  },
  {
    ...
    description: "SSD NVMe de última geração com velocidades extremas para carregamento instantâneo de ferramentas de análise.",
    iconName: 'HardDrive',
  ...
  },
  {
    ...
    description: "Processador topo de gama com arquitetura híbrida para processamento paralelo de alto nível.",
    iconName: 'Cpu',
  ...
  },
  {
    ...
    description: "Estação de trabalho móvel com ecrã gigante e poder de processamento equivalente a um desktop.",
    iconName: 'Laptop',
  ...
  },
  {
    ...
    description: "Desktop empresarial montado sob medida para máxima segurança e desempenho em redes corporativas.",
    iconName: 'Laptop',
  ...
  },
  {
    ...
    description: "Monitor de alta definição com fidelidade de cor excepcional para visualização de sistemas complexos.",
  ...
  },
  {
    ...
    description: "Teclado mecânico de resposta rápida para operadores que exigem precisão em cada tecla pressionada.",
    iconName: 'Router',
    specs: ["Switches Amarelos Silenciosos", "Chapas de Alumínio", "Teclas Macro Dedicadas", "RGB Chroma"],
    category: "Teclado"
  },
  {
    id: 'mouse-logitech-g502',
    title: "Logitech G502 X Plus",
    description: "O rato sem fios mais avançado para ergonomia e produtividade em ambientes de monitorização.",
  ...
  },
  {
    ...
    description: "A placa de vídeo definitiva para computação acelerada por GPU e inteligência artificial.",
    iconName: 'Cpu',
    specs: ["24GB GDDR6X", "Arquitetura Ada Lovelace", "Núcleos Tensor 4.ª Gen", "Ventoinhas Axial-tech"],
    category: "Placa de vídeo"
  },
  {
    id: 'gamer-bundle-pro',
    title: "Cadeira NXR Stealth Pro",
    description: "Equipamento ergonómico desenhado para longas horas de operação sem comprometer o conforto.",
    iconName: 'Briefcase',
    specs: ["Ajuste 4D Braços", "Pele Sintética Respirável", "Base de Aço Reforçada", "Almofadas Lombares"],
    category: "Gamer"
  }
];

const CATEGORIES = ['Todos', 'Memória RAM', 'Disco duro', 'SSD', 'Processador', 'Computadores', 'Monitores', 'Teclado', 'Mouse', 'Placa de vídeo', 'Gamer'];
...
const getIcon = (name: string) => {
  switch (name) {
    ...
    case 'MousePointer2': return <MousePointer2 className="w-8 h-8" />;
      ...
      >
        ...
        <div className="p-5 sm:p-8">
          <p className="text-slate-300 text-xs sm:text-sm leading-relaxed mb-6">
            {product.description} Este hardware é selecionado criteriosamente pela nossa equipa de engenharia para máxima compatibilidade com protocolos de segurança avançados.
          </p>
          ...
          <div className="bg-slate-900 p-4 border border-nxr-border rounded-sm mb-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {product.specs.map((spec, idx) => (
                <div key={idx} className="flex items-center text-[10px] sm:text-xs text-slate-400 font-mono">
      ...
      <section className="bg-nxr-dark py-16 border-b border-nxr-border">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <div className="inline-flex items-center justify-center px-4 py-1.5 bg-nxr-primary/5 border border-nxr-primary/20 rounded-full mb-6">
            ...
            <span className="text-[10px] font-mono text-nxr-primary uppercase tracking-widest">Hardware_Certificado</span>
          </div>
      ...
      <section className="py-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-wrap justify-center gap-2 p-1.5 bg-nxr-panel border border-nxr-border rounded-sm w-full sm:w-auto">
              {CATEGORIES.map(category => (
                <button
                  ...
                  className={`flex-1 sm:flex-none px-4 sm:px-6 py-2 rounded-sm text-[9px] sm:text-[10px] font-bold uppercase tracking-widest transition-all duration-300 ${activeCategory === category
        ...
        {filteredProducts.length > 0 ? (
          ...
          <div className="text-center py-24 bg-nxr-panel/30 border border-dashed border-nxr-border rounded-sm">
            ...
            <p className="text-slate-500 text-sm mb-6">Tente ajustar os termos de pesquisa ou o filtro de categoria.</p>
            <button
        ...
        <div className="p-8 md:p-12 bg-nxr-panel border border-nxr-border flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="max-w-xl">
            ...
            <p className="text-sm text-slate-400">
              A nossa engenharia de vendas pode desenhar sistemas redundantes e arquiteturas de rede completas sob medida para a sua necessidade governamental ou bancária.
            </p>
          </div>
          <Link
            to="/contact"
