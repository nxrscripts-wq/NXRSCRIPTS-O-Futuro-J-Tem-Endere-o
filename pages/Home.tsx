...
import { Shield, ArrowRight, Activity, Code2, CheckCircle, FileText, Quote } from 'lucide-react';
    ...
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-nxr-dark">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 py-32 md:py-0 text-center">
        ...
        <p className="text-base md:text-xl text-slate-400 mb-10 max-w-2xl mx-auto leading-relaxed">
          A NXRSCRIPTS entrega soluções de cibersegurança de nível empresarial, desenhadas para
          proteger infraestruturas globais contra ameaças digitais em evolução.
        </p>
    ...
    <section className="py-24 bg-nxr-dark relative border-t border-nxr-border">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <SectionHeader
          ...
          subtitle="Resultados Comprovados em Ambientes Críticos"
        />
  ...
  return (
    <section className="py-20 border-y border-nxr-border bg-nxr-panel/30">
      <div className="max-w-7xl mx-auto px-4 text-center">
        <p className="text-sm font-mono text-nxr-primary mb-8 uppercase tracking-widest">
          A Confiança de Empresas Globais
        </p>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
          {/* Placeholder Logos */}
          <AnimateIn delay={0}>
            <div className="flex items-center justify-center h-12 text-2xl font-bold font-mono">
              CORP_ONE
            </div>
          </AnimateIn>
          <AnimateIn delay={80}>
