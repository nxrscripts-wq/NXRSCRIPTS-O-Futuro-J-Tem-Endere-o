      ...
      <div className="pt-16 pb-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
                  ...
                  <AnimateIn key={tech.name} delay={Math.min(index * 80, 400)}>
                    <div className="flex items-start">
                      <div className="flex-shrink-0 mt-1">
                        <div className="w-2 h-2 rounded-full bg-nxr-primary shadow-[0_0_8px_rgba(6,182,212,0.8)]" />
                      </div>
                      <div className="ml-4">
                        <h4 className="text-lg font-semibold text-white">{tech.name}</h4>
                        <span className="text-xs font-mono text-nxr-primary uppercase mb-1 block">
                          {tech.category}
                        </span>
            ...
            <AnimateIn
              delay={200}
              className="bg-nxr-panel border border-nxr-border p-8 rounded-sm relative overflow-hidden"
            >
              <div className="absolute top-0 right-0 w-20 h-20 bg-nxr-primary/10 blur-xl" />
              ...
              <p className="text-slate-400 leading-relaxed mb-6">
                Não tratamos a segurança como um pensamento secundário. Cada linha de código, cada
                configuração de servidor e cada rota de rede é estabelecida com uma política de
                "negar por defeito". A nossa stack utiliza o que há de mais recente em
                containerização, infraestrutura imutável e verificação criptográfica.
              </p>
          ...
          <AnimateIn
            delay={100}
            className="border border-nxr-primary/30 bg-slate-900/50 p-8 rounded-lg max-w-3xl mx-auto"
          >
            ...
            <p className="text-slate-400 text-sm mb-6">
              Aproveite o nosso modelo de IA experimental (alimentado pelo Google Gemini) para obter
              resumos instantâneos sobre tópicos de segurança.
            </p>
