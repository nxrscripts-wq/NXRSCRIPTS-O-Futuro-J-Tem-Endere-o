...
const TeamMember: React.FC<{ name: string; role: string; bio: string; image: string }> = ({
  name,
  role,
  bio,
  image,
  ...
  <div className="group relative">
    <div className="relative h-80 w-full overflow-hidden rounded-sm bg-slate-800 border border-nxr-border group-hover:border-nxr-primary transition-colors duration-300">
      <img
        ...
        decoding="async"
      />
      <div className="absolute inset-0 bg-gradient-to-t from-nxr-dark via-transparent to-transparent opacity-90" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-slate-400 mb-6 leading-relaxed">
                Na NXRSCRIPTS, acreditamos que a segurança não é apenas uma funcionalidade — é a
                base da inovação. Fundada por um coletivo de investigadores de segurança de elite e
                hackers éticos, crescemos para nos tornar uma autoridade global em infraestrutura de
                cibersegurança.
              </p>
              <p className="text-lg text-slate-400 leading-relaxed">
                A nossa missão é capacitar as organizações para operarem sem medo num cenário
                digital cada vez mais hostil. Estabelecemos a ponte entre a segurança técnica
                complexa e a continuidade do negócio.
              </p>
            </div>
            <div className="relative h-96 w-full bg-slate-900 rounded-lg overflow-hidden border border-nxr-border group">
              ...
              <div className="absolute inset-0 bg-gradient-to-tr from-nxr-primary/20 to-purple-500/10 z-10" />
              <img
              ...
              <div className="absolute bottom-4 left-4 z-20">
                <div className="text-xs font-mono text-nxr-primary bg-black/80 px-2 py-1">
                  INSTALAÇÃO_SEGURA_V2.0
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
              <AnimateIn delay={0}>
                <div className="text-center p-6">
                  ...
                  <p className="text-slate-400 text-sm">
                    Precisão cirúrgica na identificação e neutralização de ameaças sem interromper
              ...
              <AnimateIn delay={80}>
                <div className="text-center p-6">
                  ...
                  <p className="text-slate-400 text-sm">
                    Proteção de ativos além-fronteiras com inteligência recolhida através de uma
                    rede mundial de sensores.
                  </p>
                </div>
              </AnimateIn>
              <AnimateIn delay={160}>
                <div className="text-center p-6">
                  ...
                  <p className="text-slate-400 text-sm">
                    Não apenas resolvemos problemas; construímos estratégias de resiliência a longo
                    prazo juntamente com os nossos clientes.
                  </p>
                </div>
              </AnimateIn>
            </div>
